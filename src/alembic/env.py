...
from core.models import FaceRecord, LivenessResult  # noqa: F401 # Ensure models are imported for Alembic
...
# Set the SQLAlchemy URL dynamically - escape % signs for ConfigParser
